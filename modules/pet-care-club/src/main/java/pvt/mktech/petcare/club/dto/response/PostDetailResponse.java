package pvt.mktech.petcare.club.dto.response;

import com.fasterxml.jackson.annotation.JsonFormat;
import io.swagger.v3.oas.annotations.media.Schema;
import lombok.Data;
import lombok.NoArgsConstructor;
import pvt.mktech.petcare.club.entity.LocationInfo;
import pvt.mktech.petcare.club.entity.MediaUrl;
...
public class PostDetailResponse implements Serializable {
    ...
    @Schema(description = "动态类型 1-好物分享 2-服务推荐 3-地点推荐 4-日常分享 5-活动打卡 6-活动报名")
