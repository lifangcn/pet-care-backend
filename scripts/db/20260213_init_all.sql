...
VALUES ('新人注册券', 1000, 365, 100000, 0, 1, 'NEWCOMER', 1) ON DUPLICATE KEY
UPDATE `name` =
VALUES (`name`), `face_value` =
VALUES (`face_value`), `valid_days` =
VALUES (`valid_days`), `per_user_limit` =
VALUES (`per_user_limit`);
